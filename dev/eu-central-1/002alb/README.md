...
| <a name="input_service_health_check_path"></a> [service\_health\_check\_path](#input\_service\_health\_check\_path) | n/a | `string` | n/a | yes |
...
| <a name="output_target_group_api"></a> [target\_group\_api](#output\_target\_group\_api) | n/a |
